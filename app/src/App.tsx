      ...
      <div className="w-screen h-screen flex items-center flex-col">
        <div className="m-10">
          <div className="flex items-center justify-center">
            <span className="absolute mx-auto py-4 flex border w-fit bg-sky-400 blur-xl bg-clip-text text-6xl box-content font-extrabold text-transparent text-center select-none">
              Run
            </span>
